...
個人的に、Plaud Note Proの推しポイントの1つがこのMCP機能です。YouTubeにはPlaudのプロモーション動画がたくさんありますが、MCPに言及しているものは見たことがありません。正直もったいないと思っています。Plaud MCPはイイぞ！と声を大にして言いたいです。
...
:::message alert
連携するサービスが増えるほど、万一マルウェアに侵入された場合の影響範囲も広がります。MCPや各種コネクタの導入は、セキュリティを考慮したうえで判断をお願いします🙇‍♂️
:::
